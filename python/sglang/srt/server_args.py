...
class ServerArgs:
    ...
    def _handle_model_specific_adjustments(self):
        ...
        # FlashInfer AllReduce Fusion supports SM90/100, enable it by default
        # for models with explicit support (DeepseekV3, GptOss, Glm4Moe, Qwen3Moe).
        # trtllm: single-node only. mnnvl: single-node and multi-node (SM100 only).
        # auto: picks best backend based on topology.
